...
//! What you write:
//! ```
//! use axon_worker::{gate_outputs, ProposedOutput, OutputChannel};
//! use axon_authority::{CapabilityVector, Grant, RespondScope};
...
use axon_authority::{CapabilityComponent, CapabilityVector, Grant};
...
mod tests {
    use super::*;
    use axon_authority::{ArtifactExportScope, RespondScope};
