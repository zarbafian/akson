...
use akson_authority::{CapabilityComponent, WorkOrderKey};
use akson_contract::{parse_payload, Capability, DecisionKind, HeadState, Identity};
...
const EXECUTOR: &str = "akson-worker";
...
fn decision_id(decision: &akson_ext::dsse::Envelope) -> String {
...
mod tests {
    ...
    fn store() -> Store {
        let kek = akson_store::envelope::Kek::from_bytes([21u8; 32]);
