...
//! [`axon_crypto::jws`]; this module only supplies the card → payload mapping
...
//! What you write:
//! ```
//! # use axon_proto::card_sig::{sign_card, verify_card};
//! # use axon_crypto::keypair::PurposeKey;
//! # use axon_crypto::purpose::KeyPurpose;
//! # let card: axon_proto::v1::AgentCard = serde_json::from_str(
...
pub enum CardSigError {
    ...
    NoValidSignature,
    #[error(transparent)]
    Purpose(#[from] axon_crypto::keypair::KeyError),
