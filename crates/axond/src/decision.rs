...
use axon_contract::{parse_payload, sign_decision, Decision, DecisionKind, HeadState, Identity};
...
mod tests {
    ...
    use axon_contract::verify_decision;
    ...
    fn store() -> Store {
        let kek = axon_store::envelope::Kek::from_bytes([11u8; 32]);
