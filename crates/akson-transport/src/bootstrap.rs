...
//! handshake, and hands the request to `akson_pairing::http::handle_http`.
//!
...
//! in `akson_pairing::http::handle_http` (a global ledger check: no live
...
use akson_pairing::http::handle_http;
