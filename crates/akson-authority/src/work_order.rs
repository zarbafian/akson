...
//! What you write:
//! ```
//! use akson_authority::{WorkOrder, WorkOrderKey, CapabilityVector, Grant, RespondScope};
//! # use akson_authority::{Audience, RequestOrigin, Budgets};
//! # use akson_contract::Identity;
//! # let order = WorkOrder {
//! #   version: 1, work_order_id: "11111111-1111-4111-8111-111111111111".into(),
//! #   issuer: Identity { issuer: "local".into(), agent: "authority".into(), root: "root-fixture-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".into() },
//! #   issuer_assurance: "local-human".into(),
//! #   audience: Audience { daemon: "aksond".into(), executor: "worker-1".into() },
//! #   request_origin: RequestOrigin { peer: Identity { issuer: "iss".into(), agent: "requester".into(), root: "root-fixture-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".into() }, tls_certificate_sha256: "ab".repeat(32) },
